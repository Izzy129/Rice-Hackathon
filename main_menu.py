...
start_button = Button((screenWidth // 4, screenHeight * 3 // 4 +100), "Start", button_font, BUTTON_TEXT_COLOR, BUTTON_HOVER_COLOR)
buttons.append(start_button)

                     #image,           (x_coord, y_coord),                  text,       font,      base_color,       hovering_color
options_button = Button((screenWidth // 2, screenHeight * 3 // 4 +100), "Options", button_font, BUTTON_TEXT_COLOR, BUTTON_HOVER_COLOR)
buttons.append(options_button)

                     #image,           (x_coord, y_coord),                  text,       font,      base_color,       hovering_color
quit_button = Button((screenWidth * 3 // 4, screenHeight * 3 // 4  +100), "Quit", button_font, BUTTON_TEXT_COLOR, BUTTON_HOVER_COLOR)
...
def main_menu():
    ...
    while running:
        ...
        window.blit(TITLE_TEXT, (screenWidth // 2 - TITLE_TEXT.get_width() // 2, screenHeight // 4 - TITLE_TEXT.get_height() // 2 - 100))


        # place stonks image on title screen
        stonks_image = pygame.image.load(r"Assets\stonks_title.jpg")
        stonks_image = pygame.transform.scale(stonks_image, (screenWidth // 2, screenHeight // 2))
        window.blit(stonks_image, (screenWidth // 4, screenHeight // 4))
